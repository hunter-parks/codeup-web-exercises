...
//     var elementHatSearch = document.getElementById("hat-search");
//         console.log(elementHatSearch);
...
// TODO: Now that we have a variable with all of the elements, can you tell me how many divs are in the HTML using that variable and a little Javascript? Hint: the variable looks and behaves a lot like an array, doesn't it? That helped us in our for loop's condition!
     /*   console.log(divElements.length + " is how many divs are in the HTML!");*/
...
var navbarName = document.getElementsByClassName("navbar-brand")

// console.log(navbarName);

navbarName[0].innerText = "Hunter's"
...
for (var i = 0; i < topSellers.length; i++){
    topSellers[i].innerHTML = "<strong> Fitted Hat</strong>"
}
...
navbarToggler.setAttribute("name","navbar-collapser");
console.log(navbarToggler);
...
var mainContentOfPage = document.getElementsByClassName("main-content");
console.log(mainContentOfPage);
mainContentOfPage[0].style["background-color"] = "grey";

var topHeaderOfPage = document.getElementsByClassName("jumbotron");
console.log(topHeaderOfPage);
topHeaderOfPage[0].style["backgroundColor"] = "maroon";

var bodyElement = document.getElementsByTagName("body");
console.log(bodyElement);
bodyElement[0].style["background-color"] = "#F5F5DC";
...
var fontChange = document.getElementsByTagName("body");
fontChange[0].style.fontFamily = "'Syne Mono', monospace";