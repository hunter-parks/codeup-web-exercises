...
function switchAnalyzeColor(input){
    switch (input){
        ...
        default:
            return "I don't anything about " + input;
    }
 ...
 */
 ...
 function calculateTotal(luckyNumber,totalAmount){
   ...
   window.alert ("Please go draw a lucky number between 0-5! ");
     }
...
var userTotalBill = Number(prompt("What was your total bill? "));
var discountedBill = calculateTotal(luckyNumber,userTotalBill);
alert("Your lucky number was " + luckyNumber);
alert("Your price before the discount was $ " + userTotalBill + ", However with the discount you only have to pay $ " + discountedBill + ".")
