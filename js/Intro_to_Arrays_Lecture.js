...
var daysOfTheWeek = ['Monday', "Tuesday", "Wednesday", "Thursdays", "Friday", "Saturday", "Sunday"];
console.log(daysOfTheWeek);


// TODO: create an array of favorite foods and set to a variable called `favoriteFoods` - then console.log the variable

var favoriteFoods = ["Pasta", "Tacos", "Burgers"];
...
console.log(" The length of days of week are: " + daysOfTheWeek.length);
// console.log("The length of days of week array is: " + );


// TODO: console.log the length of the favoriteFoods array

console.log(" The length of favorite foods is: " + favoriteFoods.length);
