...
//TODO together: Let's set up a string with HTML to replace this old list with our updated best sellers - FEDORAS have moved into the number one spot!
    ...
    html = "<h4 class=\"best-seller-header\">Our Top Sellers</h4><ol>" +
        "<li class='hats-sold'>Fedora Hats</li>" +
        "<li class='hats-sold'>Baseball Hats</li>" +
        "<li class='hats-sold'>Cowboy Hats</li></ol>"
...
$(".hats-sold").each(function(index,ele){ // iterate over matched elements
    if (index !== 0){
